...
<div class="row">
  <div class="col-sm mt-3 mt-md-0">
    {% include figure.liquid loading="eager" path="assets/img/contrail_output1.png" title="Instantaneous Contrail Snapshots and scaling of ice scattering from varying exhaust conditions" class="img-fluid rounded z-depth-1" %}
  </div>
</div>
